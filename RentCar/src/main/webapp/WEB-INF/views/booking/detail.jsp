    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            <div class="container">
                ...
                <form class="form-horizontal" action="/user/booking/create" method="post" enctype="multipart/form-data" 
                style="width: 50%; display: flex; flex-direction: column; margin-left: 25%;"
