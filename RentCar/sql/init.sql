...
CREATE TABLE `caroption` (
  `bluetooth` char(4) DEFAULT NULL,
  `rear_sensor` char(4) DEFAULT NULL,
  `rear_camera` char(5) DEFAULT NULL,
  `black_box` char(4) DEFAULT NULL,
  `heated_seat` char(4) DEFAULT NULL,
  `heated_handle` char(4) DEFAULT NULL,
  `ventilated_seat` char(4) DEFAULT NULL,
  `navigation` char(5) DEFAULT NULL,
  `non_smoking_vehicle` char(4) DEFAULT NULL,
  `smart_key` char(4) DEFAULT NULL,
  `sunroof` char(3) DEFAULT NULL,
  `rear_warning_light` char(5) DEFAULT NULL,
  `Lane_Departure_Prevention` char(6) DEFAULT NULL,
  `carnumber` varchar(8) DEFAULT NULL,
  KEY `carnumber` (`carnumber`),
  CONSTRAINT `caroption_ibfk_1` FOREIGN KEY (`carnumber`) REFERENCES `carinfo` (`carnumber`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-07-31 15:20:17
